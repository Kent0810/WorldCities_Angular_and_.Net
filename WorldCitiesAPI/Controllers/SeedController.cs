...
using OfficeOpenXml;
using WorldCitiesAPI.Data; //include the ApplicationDbContext.ccs file
...
namespace WorldCitiesAPI.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<ActionResult> Import() { 
            ...
            using var steam = System.IO.File.OpenRead(path);
            using var excelPackage = new ExcelPackage(steam);
